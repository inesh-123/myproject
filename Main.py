...
#Function-10 Image uploading for classification task and display it in the textarea
...
#Function-11 Generating Which type of Disease for the given images is to be generated using this function.
...
#Function-12 Information regarding the disease.
...
#Function-13 For opening a New tab for displaying hospital information nearer to you!

def NearbyHos():
      webbrowser.open("https://www.google.com/search?q=dermatologist+near+me") 


#Function-14  For Closing the Desktop Application finally! Happy Ending...!!!
...
processButton = Button(main, text="Preprocess Dataset", command=preprocessDataset, padx=5, font=bold_font,
    pady=5, bg='#4a7abc', fg='white', activebackground='green', activeforeground='white')
processButton.place(x=20,y=220)
...
RROverSampleButton = Button(main, text="Run Random OverSampling", command=RunRandOverSamp , padx=5, font=bold_font,
    pady=5, bg='#4a7abc', fg='white', activebackground='green', activeforeground='white')
RROverSampleButton.place(x=20,y=460)
